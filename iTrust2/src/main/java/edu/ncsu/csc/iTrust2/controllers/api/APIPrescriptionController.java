...
public class APIPrescriptionController extends APIController {
    ...
    /**
     * Returns a patients prescription
     *
     * @param username
    ...
    @GetMapping ( BASE_PATH + "/prescriptions/advocate/{username}" )
    public List<Prescription> getPrescriptions ( @PathVariable final String username ) {
        final User patient = userService.findByName( username );
        loggerUtil.log( TransactionType.PATIENT_ADVOCATE_VIEW_DATA, username );
