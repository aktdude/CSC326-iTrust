...
public class PatientController {
    ...
    /**
     * Create a page for the patient to manage advocate permissions
     *
     * @param model
     *            data for front end
     * @return The page for the patient to manage advocate permissions
     */
    @GetMapping ( value = "patient/manageAdvocatePermissions" )
    @PreAuthorize ( "hasRole('ROLE_PATIENT')" )
    public String manageAdvocatePermissions ( final Model model ) {
        return "/patient/manageAdvocatePermissions";
    }
