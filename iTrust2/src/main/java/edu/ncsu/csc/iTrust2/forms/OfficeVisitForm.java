...
public class OfficeVisitForm implements Serializable {
    ...
    /**
     * A list of patient advocates related to the office visit
     */
    private List<String>           patientAdvocatesPresent;
    ...
    public OfficeVisitForm ( final OfficeVisit ov ) {
        ...
        setPatientAdvocatesPresent(
                ov.getPatientAdvocatesPresent().stream().map( User::getUsername ).collect( Collectors.toList() ) );
    }
     ...
     *
     * @return a list of the patient advocates present
     */
    public List<String> getPatientAdvocatesPresent () {
        return this.patientAdvocatesPresent;
    }

    /**
     * Sets the patient advocates present
     *
     * @param presentPatientAdvocates
     *            the patient advocates present
     */
    public void setPatientAdvocatesPresent ( final List<String> presentPatientAdvocates ) {
        this.patientAdvocatesPresent = presentPatientAdvocates;
    }
