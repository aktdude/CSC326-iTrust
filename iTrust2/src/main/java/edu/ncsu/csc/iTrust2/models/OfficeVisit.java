...
public class OfficeVisit extends DomainObject {
    ...
    /**
     * The patient advocates present at an appointment, if any.
     */
    @ManyToMany
    private List<User>           patientAdvocatesPresent;
    ...
    /**
     * Returns a list of the patient advocates present at the appointment
     *
     * @return the list
     */
    public List<User> getPatientAdvocatesPresent () {
        return patientAdvocatesPresent;
    }

    /**
     * Sets the list of patient advocates present at the office visit.
     *
     * @param patientAdvocatesPresent
     *            the list of patient advocates present
     */
    public void setPatientAdvocatesPresent ( final List<User> patientAdvocatesPresent ) {
        this.patientAdvocatesPresent = patientAdvocatesPresent;
    }
