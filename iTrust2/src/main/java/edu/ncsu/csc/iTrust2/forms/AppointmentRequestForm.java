...
public class AppointmentRequestForm {
    ...
    /**
     * A list of patient advocates invited to the appointment request.
     */
    private List<String> patientAdvocatesInvited;
    ...
    public AppointmentRequestForm ( final AppointmentRequest request ) {
        ...
        setPatientAdvocatesInvited(
                request.getPatientAdvocatesInvited().stream().map( User::getUsername ).collect( Collectors.toList() ) );
    }
    ...
    /**
     * Get the patient advocates present
     *
     * @return a list of the patient advocates invited
     */
    public List<String> getPatientAdvocatesInvited () {
        return this.patientAdvocatesInvited;
    }

    /**
     * Sets the patient advocates invited
     *
     * @param invitedPatientAdvocates
     *            the patient advocates invited
     */
    public void setPatientAdvocatesInvited ( final List<String> invitedPatientAdvocates ) {
        this.patientAdvocatesInvited = invitedPatientAdvocates;
    }
}
