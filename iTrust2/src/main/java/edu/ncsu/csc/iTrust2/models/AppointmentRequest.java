...
public class AppointmentRequest extends DomainObject {
    ...
    /**
     * The patient advocates invited to see an appointment request, if any.
     */
    @ManyToMany
    private List<User> patientAdvocatesInvited;
    ...
    /**
     * Returns a list of the patient advocates allowed to view the appointment.
     *
     * @return the list
     */
    public List<User> getPatientAdvocatesInvited () {
        return patientAdvocatesInvited;
    }

    /**
     * Sets the list of patient advocates allowed to view the appointment.
     *
     * @param patientAdvocatesInvited
     *            the list of patient advocates invited
     */
    public void setPatientAdvocatesInvited ( final List<User> patientAdvocatesInvited ) {
        this.patientAdvocatesInvited = patientAdvocatesInvited;
    }
}
