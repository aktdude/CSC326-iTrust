...
public class Personnel extends User {
    ...
    /**
     * The middle name of the personnel
     */
    private String middleName;

    /**
     * The nickname of the personnel
     */
    ...
    /**
     * Create a new personnel for advocate based off of the PersonnelForm
     *
     * @param form
     *            the filled-in personnel form with personnel information
     * @return `this` Personnel, after updating from form
     */
    public Personnel updateAdvocate ( final AdvocateForm form ) {
        update( form );
